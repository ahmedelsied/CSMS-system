    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                <form method="POST" action="<?=DOMAIN?>/inventory/add_inside_sales/add">
                    <h3>إضافة عملية بيع داخلي </h3>
                    <br><br>
                    <div class="input-parent">
                        <select class="form-control clothing-type" name="piece-type" required="required" style="padding: 0;">
                            ...
                            <?php foreach($this->inv_catgs as $catgs): ?>
                                <option value="<?=$catgs['id']?>"><?=$catgs['catg_name']?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="input-parent">
                    ...
                    <div class="input-parent">
                        <input class="form-control" type="text" name="money" placeholder="المبلغ" required="required"/>
                    </div>
                    <div class="input-parent">
