            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table id="orders-table" class="table table-bordered table-striped" data-url="uncompleted_orders">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-danger">سبب عدم التوصيل</th>
                            ...
                            <tbody id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td class="govs"><?=$order['government_name']?></td>
                                    ...
                                    <td class="sales"><?=$order['sales_representative_full_name']?></td>
                                    <td class="reason_of_undelivery"><?=$order['reason_of_undelivery']?></td>
                                    <td class="date"><?=$order['request_date']?></td>
                        ...
                        <div class="text-center">
                            <button class="btn btn-danger w-btn" id="send-orders" data-url="/supervisor/uncompleted_orders/send_uncompleted_orders">إرسال
