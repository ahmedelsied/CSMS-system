                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-12">
                                    ...
                                    <p class="date-card active-date-card" data-date="curr_month" id="date-target" data-url="customers_service">الشهر الحالي</p>
                                </div>
                            </div>
                        </div>
                        <div class="container-fluid">
                            ...
                            <table id="orders-table" class="table table-bordered table-striped">
                                ...
                                <?php foreach($this->all_orders as $orders): ?>
                                    <tr>
                                        ...
                                        <td class="customers_service"><?=str_replace('"', '',$orders['customers_service_full_name'])?></td>
                                        <td class="orders"><?=$orders['count_of_orders']?></td>
                                        <td class="data"><?=str_replace('"', '',$orders['request_date'])?></td>
                                    </tr>
                                <?php endforeach; ?>
                                <?php endif; ?>
                                </tbody>
