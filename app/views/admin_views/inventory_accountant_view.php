                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-12">
                                    ...
                                    <p class="date-card active-date-card" data-date="curr_month" id="date-target" data-url="inventory_accountant">الشهر الحالي</p>
                                </div>
                            </div>
                        </div>
                        <div class="container-fluid">
                            ...
                            <table id="orders-table" class="table table-bordered table-striped">
                                ...
                                <?php foreach($this->all_orders as $orders): ?>
                                    <tr>
                                        ...
                                        <td class="inventory_accountant_name"><?=$orders['inventory_accountant_full_name']?></td>
                                        <td class="orders"><?=$orders['count_of_process']?></td>
                                        <td class="inv_name"><?=$orders['inventory_name']?></td>
                                        <td class="data"><?=$orders['process_date']?></td>
                                    </tr>
                                <?php endforeach; ?>
                                <?php endif; ?>
                                </tbody>
